<?php if ( get_field ( 'informationdirections', 'options' )) : ?>
  <p class="timeline-label--desktop"><?php the_field( 'informationdirections', 'options' ); ?></p>
<?php endif; ?>
<?php if ( get_field( 'mobile_directions', 'options' ) ) : ?>
  <p class="timeline-label--mobile"><?php the_field( 'mobile_directions', 'options' ); ?></p>
<?php endif; ?>

<?php if ( have_rows( 'stops', 'options' ) ) : ?>

  <div class="timeline-wrap">

    <ul class="timeline">
      <?php while ( have_rows( 'stops', 'options' ) ) : the_row(); ?>
        <?php 
